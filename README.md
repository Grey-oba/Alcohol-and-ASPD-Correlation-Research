...
- Designing research questions and structuring analytical investigations.
- Creating clear, data‑driven visualisations to communicate findings effectively.
- Translating statistical outputs into meaningful behavioural and psychological insights.

### Tools Used
- R programming language for statistical modelling, correlation analysis, and data visualisation.
- ggplot2 and other R visualisation libraries for generating progression graphs.
- Research frameworks for structuring behavioural and psychological analysis.


<img width="1280" height="719" alt="image" src="https://github.com/user-attachments/assets/29c44b16-a3bd-4649-8505-9558a6b8ae30" />
*Ref 1: Poster with summary of research*
